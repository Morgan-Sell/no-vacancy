...
class TrainData(Base):
    ...
    is_repeat_guest = Column(Integer, nullable=False)
    num_previous_cancellations = Column(Integer, nullable=False)
    num_previous_bookings_not_canceled = Column(Integer, nullable=False)
    special_requests = Column(Integer, nullable=False)
